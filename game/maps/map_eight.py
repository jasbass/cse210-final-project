...
class MapEight(Map):
    def __init__(self) -> None:
        super().__init__()
        self._tilemap = [
        'BDBBBBBBBBBBBBBBBBBBBBBBB',
        'B....BB..B.....B..B...B.B',
        'B..B.....B.B.BBB..B.B...B',
        'BBBB.BBB.B.B......B.B.BBB',
        'B....B....BBBBBBB.B.B.B.B',
        'BBBBBBBBB.B.....B...B...B',
        'B...B.B...B.BBB.B.BBBBB.B',
        'B.B.....B.B...B.B.B...B.B',
        'B.BBBB.BB.B.B.BBB.B.B.B.B',
        'B....B..B.B.B..B....B.B.B',
        'BBBBBBB.BBBBBB.BBBBBBBB.B',
        'B.......B......B........B',
        'B.BBBBB.B.BBBB.B..B.B.BBB',
        'B..B....B....B...BB.B...B',
        'BB.B.BBBBBBB.B.B..B.B.B.B',
        'B..B.B.B...B...B..B...B.B',
        'B.BBBB.B.B.BBBBBB.B.BBBBB',
        'B........B........B.....B',
    ...
    def _add_text_sprites(self, cast):
        x = 200
        y = 0
        text = 'An interesting defense mechanism...'
